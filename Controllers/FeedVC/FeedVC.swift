...
class FeedVC: UIViewController {
    ...
    func setupTableView() {
        ...
        // tableView.register(FeedTableViewCell, forCellReuseIdentifier: "feedCell")
        tableView.register(UINib.init(nibName: "FeedTableViewCell", bundle: nil), forCellReuseIdentifier: "feedCell")
        view.addSubview(tableView)
        
        self.tableView.delegate = self
        self.tableView.dataSource = self // arrayOfSnaps as! UITableViewDataSource
        /* PART 2A FINISH */
    }
